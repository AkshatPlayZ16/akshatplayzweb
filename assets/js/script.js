...
window.alert = (text = "", theme = "danger") => {
        ...
        try {
          i === 1
            ? (() => {
                ...
                e.innerHTML = `<div class="alert" role="alert">${text}</div>`;
              })()
            : e.remove();
    ...
    document.body.insertAdjacentHTML("afterbegin", `<div class="custom_alert ${theme}"><div class="alert">${text}</div></div>`);
  ...
  //   const hoverElems = ["a", ".card", "img", "button"];
  //   const Elems = [];
  //   // const getAll = document.querySelectorAll;
  //   hoverElems.forEach((e) => {
  //     Elems.push(...document.querySelectorAll(e));
  //   });
  ...
  window.addEventListener("load", function () {
    //     const preloader = document.querySelector(".loadingWrapper");
    //     preloader.classList.add("loadingDone");
  });